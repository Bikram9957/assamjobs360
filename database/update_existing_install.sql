...
ALTER TABLE users ADD COLUMN state VARCHAR(120) NULL AFTER address;
ALTER TABLE users ADD COLUMN district VARCHAR(120) NULL AFTER state;
ALTER TABLE users ADD COLUMN pin_code VARCHAR(10) NULL AFTER district;
