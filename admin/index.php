...
$userCount = (int)$mysqli->query("SELECT COUNT(*) AS c FROM users")->fetch_assoc()['c'];
...
<body class="admin-page">
  <div class="container py-4">
    ...
    <div class="row g-3 mb-3">
      ...
      <div class="col-12 col-md-3"><div class="card h-100"><div class="card-body"><div class="small text-muted text-uppercase fw-semibold">Mock Tests</div><div class="display-6 fw-bold text-success"><?= $mockTestCount ?></div><a class="small text-decoration-none" href="<?= aj360_h(aj360_url('admin/mock_tests.php')) ?>">Manage mock tests →</a></div></div></div>
      <div class="col-12 col-md-3"><div class="card h-100"><div class="card-body"><div class="small text-muted text-uppercase fw-semibold">Public Users</div><div class="display-6 fw-bold" style="color:#0f766e"><?= $userCount ?></div><a class="small text-decoration-none" href="<?= aj360_h(aj360_url('admin/users.php')) ?>">Manage users →</a></div></div></div>
    </div>
    <div class="row g-3">
      <div class="col-12">
        <div class="card manage-card"><div class="card-body">
          ...
          <div class="manage-grid">
            ...
            <a class="manage-tile" href="<?= aj360_h(aj360_url('admin/users.php')) ?>"><span class="manage-icon">U</span><span><b>Users</b><small>View, edit and remove public users</small></span><i>→</i></a>
